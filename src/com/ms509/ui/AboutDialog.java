...
public class AboutDialog extends JDialog {
	...
	public AboutDialog() {
		super(FuzzDomain.getMain(), "关于 FuzzDomain", true);
		this.setComponent();
		// 初始化布局和控件
	...
	private void setComponent() {
		...
		String copy = "<html><body><div><h3 style=\"text-align:center;\">Copyright(c) 2016-2017 MS509 Team</h3></div>"
				...
				+ "<div style=\"text-align:right;font-size:9px;\">Powered by Chora&nbsp;&nbsp;&nbsp;&nbsp;</div>"
				+ "</body></html>";
		...
		this.setTitle("关于 FuzzDomain");
		this.setLocationRelativeTo(FuzzDomain.getMain());
	}
